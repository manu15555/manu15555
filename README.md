...
|-----------------------------------------------|----------------------------|
| Infrastructure as Code (Terraform) | Terraform Projects |
| AWS Infrastructure Design | AWS Solutions Architect |
| AWS Cloud Services | AWS Cloud Practitioner |
| Infrastructure Provisioning | Terraform Projects |
| Multi-AZ Architecture Design | RDS Multi-AZ Deployment |
| Infrastructure Import & State Management | Import Existing Lambda into Terraform |
| IAM & Access Management | IAM Labs |
| Cloud Security Best Practices | AWS & Azure Labs |
| Security Monitoring & Incident Analysis | SOC Analyst Experience |
| SIEM Log Analysis | Splunk |
| Microsoft Defender XDR | SOC Operations |
| Linux Administration | Practical Ethical Hacking Labs |
| Python Automation | Cloud & Security Labs |
